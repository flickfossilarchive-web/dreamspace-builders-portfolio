      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
        ...
        <div className="lg:col-span-3 space-y-8">
          <div>
           ...
           <div>
            <h2 className="text-3xl font-headline font-bold text-foreground mb-4">Our Philosophy</h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
       ...
       <div className="py-20 md:py-28">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-headline font-bold tracking-tight text-foreground">Our Core Values</h2>
          <p className="mt-3 text-lg text-muted-foreground max-w-2xl mx-auto">
            The principles that guide our work and define our character.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="text-center bg-card shadow-lg hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300">
            <CardHeader>
