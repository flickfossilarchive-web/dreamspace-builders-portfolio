...
import { Home, LogOut, Mail, PlusSquare, Building2, Loader2, FolderKanban } from 'lucide-react';
...
export default function AdminDashboardLayout({ children }: { children: ReactNode }) {
  ...
  if (isCheckingAuth || !isAuthenticated) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="h-7 w-7 animate-spin text-primary" aria-label="Checking admin access" /></div>;
