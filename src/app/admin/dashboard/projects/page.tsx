...
import { FolderKanban, Plus, ExternalLink, Trash2, Search, MapPin, Star } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div><p className="eyebrow">Portfolio management</p><h1 className="mt-2 font-headline text-4xl font-bold tracking-tight">Projects</h1><p className="mt-2 max-w-2xl text-muted-foreground">Manage your public case studies, featured projects and unpublished work from one place.</p></div>
